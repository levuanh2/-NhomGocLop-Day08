...
from .task6_lexical_search import lexical_search, _ensure_corpus
from . import task6_lexical_search as _t6  # Module-level access so CORPUS ref stays live after reassign
